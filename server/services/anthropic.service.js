...
function buildFallbackAnswer(analytics) {
  ...
  return [
    '## Summary',
    'AI model access is not configured on the backend, so this response is using TransportFlow rule-based analytics only.',
    '',
    ...
    '',
    '## Recommendation',
    '- Ask an administrator to set ANTHROPIC_API_KEY in the backend environment to enable natural-language AI analysis.',
